...
(function() {
  window.EasyNote = (function() {
    EasyNote.prototype.NOTEBOOK = null;

    EasyNote.prototype.WIDTH = null;

    EasyNote.prototype.HEIGHT = null;

    EasyNote.prototype.LINE_SPACE = 25;
    ...
    function EasyNote() {
      ...
      this.setupCanvas();
      this.NOTEBOOK = new window.Notebook(this.canvas);
    }
    ...
    EasyNote.prototype.setupCanvas = function() {
      ...
      return $(cnv).on('mouseup touchend', function(event) {
